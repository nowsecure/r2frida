...
const inModules = [];
export function stalkFunction (config, address) {
...
export function stalkEverything (config, timeout) {
  return new Promise((resolve, reject) => {
    _clearEvents();
    _initModules(config);
